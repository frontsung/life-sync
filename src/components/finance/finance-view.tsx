...
export function FinanceView({ transactions, ownerUid, onDataChange }: FinanceViewProps) {
  ...
  const { user } = useAuth(); // Get current user for idToken
  ...
  const handleFormSubmit = (formData: FormData) => {
    ...
    startTransition(async () => {
      ...
      if (editingId) {
        ...
        await updateTransaction(null, formData, idToken);

      } else {

        await addTransaction(null, formData, idToken);
                    ...
                    <td className="px-6 py-4 text-center flex items-center justify-center gap-2">
                      ...
                      <button 
                        ...
                        onClick={() => startTransition(async () => {
                          ...
                          await deleteTransaction(transaction.id, ownerUid, idToken);
